...
def createDatasource(
    jdbc_provider: ConfigurationObjectName, datasource_config: _Union[str, list]
) -> _Any:
...
@_overload
def createTCPEndPoint(
    target_object: ConfigurationObjectName, /
...
@_overload
def createTCPEndPoint(
    target_object: ConfigurationObjectName, options: _Union[str, _List[str]], /
) -> ConfigurationObjectName:
    ...
...
def listChains(
    acceptor_filter: ConfigurationObjectName, endpoint_filter: str, /
) -> MultilineList[ConfigurationObjectName]:
...
def listServerTypes(
    target_node: _Union[ConfigurationObjectName, str] = "", /
) -> MultilineList[str]:
